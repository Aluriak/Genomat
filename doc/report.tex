...
\section{Conclusion \& Perspectives}
    ...
    With some lines of code, its possible to perform phylogenetic tree, genealogy, regulation statistics, multiple phenotypes, scoring on phenotypes, multiple gene KO survivability, periodicity, \textit{et cetera}.
    \paragraph*{}
    Finally, Wagner's genes networks model appears as an interesting and powerful genetic algorithm sand box that allow many studies, despite a simple selection behavior (no explicit scoring, only binary selection).
