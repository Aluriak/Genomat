...
\subsection{Mutation rate variation}
    ...
    Each gene is more or less essential. We do not notice a stabilization to a resistance to gene KO survivability of 1, 
...
\subsection{Consanguinity in a small population}
    ...
    We then can notice that there is no essential gene. At first, gene 2 becomes essential with a big drop in its survivability ratio from 1 to 0.4 
