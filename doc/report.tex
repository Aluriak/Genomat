...
\section*{Results through graphics}
    ...
    \begin{figure}[H] 
      ...
      \begin{tikzpicture}
          \begin{axis}[
              ...
              \addplot[line width=1.0pt, mark=x]
                       table [col sep=comma,x=generationnumber,y=viabilityratio3] {ps200xg300xmr1-10-4.csv}; 
    ...
    \paragraph*{}
    For this for fourth graph, first, we can notice that the resistance to gene 2 survivability ratio is 
   we can notice that the resitance to gene 3 survivability ratio doesn't increase as fast as the three others (genes 0, 1, 4)
