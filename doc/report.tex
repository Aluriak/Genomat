    ...
    \begin{figure}[H] 
      ...
      \begin{tikzpicture}
          \begin{axis}[
              ...
              \addplot table [col sep=comma,x=generationnumber,y=viabilityratio0] {test.csv};
              \addplot table [col sep=comma,x=generationnumber,y=viabilityratio1] {test.csv};
              \addplot table [col sep=comma,x=generationnumber,y=viabilityratio2] {test.csv};
              \addplot table [col sep=comma,x=generationnumber,y=viabilityratio3] {test.csv};
              \addplot table [col sep=comma,x=generationnumber,y=viabilityratio4] {test.csv};
              \addplot table [col sep=comma,x=generationnumber,y=diversity]       {test.csv};
