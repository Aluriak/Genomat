    ...
    \begin{figure}[h!] 
      ...
      \begin{tikzpicture}
          \begin{axis}[
              ...
              %pop_size,gene_number,generation_number,viability_ratio_0,viability_ratio_1,viability_ratio_2,viability_ratio_3,viability_ratio_4
              \addplot table [col sep=comma,x=generationnumber,y=viabilityratio0] {300x100x4xdB.csv};
              \addplot table [col sep=comma,x=generationnumber,y=viabilityratio1] {300x100x4xdB.csv};
              \addplot table [col sep=comma,x=generationnumber,y=viabilityratio2] {300x100x4xdB.csv};
              \addplot table [col sep=comma,x=generationnumber,y=viabilityratio3] {300x100x4xdB.csv};
              \addplot table [col sep=comma,x=generationnumber,y=viabilityratio4] {300x100x4xdB.csv};
              \legend{Gene 0, Gene 1, Gene 2, Gene 3, Gene 4}
          \end{axis}
      \end{tikzpicture}
    ...
    \begin{figure}[h!] 
      ...
      \begin{tikzpicture}
          \begin{axis}[
              ...
              %pop_size,gene_number,generation_number,viability_ratio_0,viability_ratio_1,viability_ratio_2,viability_ratio_3,viability_ratio_4
              \addplot table [col sep=comma,x=generationnumber,y=viabilityratio0] {300x100x2xdB.csv};
              \addplot table [col sep=comma,x=generationnumber,y=viabilityratio1] {300x100x2xdB.csv};
              \addplot table [col sep=comma,x=generationnumber,y=viabilityratio2] {300x100x2xdB.csv};
              \addplot table [col sep=comma,x=generationnumber,y=viabilityratio3] {300x100x2xdB.csv};
              \addplot table [col sep=comma,x=generationnumber,y=viabilityratio4] {300x100x2xdB.csv};
              \legend{Gene 0, Gene 1, Gene 2, Gene 3, Gene 4}
          \end{axis}
      \end{tikzpicture}
